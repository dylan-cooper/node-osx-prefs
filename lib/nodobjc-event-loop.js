/*
From the nodobjc examples directory, modified to fit the needs of this application.
This interfaces the libuv and Objective C runtime loops.
*/
...
EventLoop.prototype.eventLoopCore = function(block) {
  ...
  var runInfo = this.runInfo,
      ...
      //Change this line and the high CPU utilization was solved... will try to figure out what
      // is going on here at a later date.
      // untilDate = block ? $.NSDate('distantFuture') : null, // or $.NSDate('distantPast') to not block
      //Note: this was recommended by shanewholloway who originally wrote this file
